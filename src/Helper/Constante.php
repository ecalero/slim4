...
class Constante {
	CONST DOMAINSITE = "http://slim4.trabajo.ed/";
...
/* contenidos personalizados */
	...
	CONST CLAVE_RESET = 12345;

	//estado de curso convoy
	CONST ESTADO_PROGRAMADO_CONVOY = 307;
	CONST ESTADO_ENCURSO_CONVOY = 308;

	CONST ID_TIPO_PERSONA = 8;
	CONST TIPO_PERSONA_NATURAL = 24;
	CONST TIPO_PERSONA_JURIDICA = 25;
	CONST ID_GENERO=44;

	//constante tabla de tabtablas
	CONST TIPO_VEHICULO_PESO=39;
	CONST MARCA_VEHICULO=41;
	CONST TIPO_VEHICULO_FORMA=42;
