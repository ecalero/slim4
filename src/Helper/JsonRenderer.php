...
class JsonRenderer
{
  ...
  public static function  render(ResponseInterface $response, $statusCode = 200, array $data = [])
  {
    ...
    $newResponse = $response->withHeader('Access-Control-Allow-Headers', 'Origin, X-Requested-With, Content-Type, Accept');
    $newResponse = $response->withHeader('Access-Control-Allow-Methods', 'GET, POST, PUT, DELETE');
